...
var questions = [
    ...
    new Question("Z szeregowaniem loterejnym nie wiąże się fakt, że",["procesy otrzymuja losy na poszczególne zasoby","współpracujące procesy mogą wymieniać się losami","zależy od doboru kwantu czsu","niektóre procesy mogą otrzymywać większą ilość losów"],"zależy od doboru kwantu czsu"),
    ...
    new Question("Idealna pamieć",["Jest ulotna","Jest tania","Nie istnieje","Jest nieskończenie duża"],"Nie istnieje"),
    ...
    new Question("Translancja adresu",["Była używana dawniej w komputerach 8-bitowych","Jest wykonywana sprzętowo"],"Jest wykonywana sprzętowo"),
    ...
    new Question("Dostęp sekwencyjny polega na tym, że",["urządzenie przesyła dane w określonej kolejności","nie wiadomo, kiedy pojawią się dane z urządzenia"],"urządzenie przesyła dane w określonej kolejności"),
    ...
    new Question("W terminologi SO semaforem nazywamy",["Ogólna implementacją algorytmy BFS","Sekcję krytyczną","Metodę dostępu do chronionego zasobu przez wiele procesów","Problem ucztujących filozofów"],"Metodę dostępu do chronionego zasobu przez wiele procesów"),
    new Question("Czy system operacyjny powinien realizować więcej niż jeden system plików",["Tak","Nie"],"Tak"),
    ...
    new Question("Efekt polecenia mkdir count to",["Ucięcie korzenia w drzewie struktury drzewiastej","Polecenie zwróci ilość katalogów w bierzącej lokalizacji","Powstanie wpisu dotyczącego nowego katalogu count"],"Powstanie wpisy dotyczącego nowego katalogu count"),
    ...
    new Question("Wybierz zdanie prawdziwe",["User IDs pozwalają nadawć prawa grupowe i grupować użytkowników","właściciel pliku, nie może edytowac jego praw","W systemach rozproszonych pliki można dzielić przez sieć"],"W systemach rozproszonych pliki można dzielić przez sieć"),
    ...
    new Question("Planista odpowiada za",["ustalanie kolejności w kolejce FIFO","procesy stale rezydujące w pamięci podręcznej","przydzielaniu czasu procesora"],"przydzielaniu czasu procesora"),
    ...
    new Question("Pamięć wirtualna to",["pamięć wytwarzana przez procesy na ich cele","pamieć, z której mogą korzystać przeglądarki internetowe","odzielenie logicznej pamięci użytkownika od pamięci fizycznej"],"odzielenie logicznej pamięci użytkownika od pamięci fizycznej"),
    new Question("Pamięć wirtualną można zrealizować za pomocą",["stronnicowania na żądanie","segmentacji na żądanie","wszystkie odpowiedzi są poprawne"],"wszystkie odpowiedzi są poprawne"),
    new Question("Kopiowanie przy zapisie",["skojarzeniu bitów poprawności z bitami niepoprawnymi w tablicy stron","sprowadzaniu strony z pamięci do tablicy stron","umożliwia początkowo procesowi macierzystemu i potomnemu na dzielenie zasobów"],"umożliwia początkowo procesowi macierzystemu i potomnemu na dzielenie zasobów"),
    new Question("Czy każdy proces wymaga pewnej minimalnej ilości stron",["Tak","Nie"],"Tak"),
    new Question("Desfree to",["Częstotliwość wymiany procesów w pamięci podręcznej","Parametr progowy rozpoczęcia stronnicowania","Parametr progowy zwiększenia stronnicowania"],"Parametr progowy zwiększenia stronnicowania"),
    new Question("Kolejka wejściowa to",['kolejka procesów przeznaczonych do "wymiecienia" z komputera',"zbiór id wszystkich użytkowników mogących wykonywać dany proces","zbiór procesów na dysku czekających na wprowadzenie do pamięci, w celu wykonania programu"],"zbiór procesów na dysku czekających na wprowadzenie do pamięci, w celu wykonania programu"),
    ...
    new Question("deadlock to",["zakleszczenie","blokada wzajemna","sytuacja, w kórej dwa procesy czekają na siebie na wzajem, więc żaden, nie może się zakończyć","wszystkie odpowiedzi są poprawne"],"wszystkie odpowiedzi są poprawne")
