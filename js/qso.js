...
var questions = [
    ...
    new Question("Z szeregowaniem loteryjnym nie wiąże się fakt, że",["procesy otrzymują losy na poszczególne zasoby","współpracujące procesy mogą wymieniać się losami","zależy od doboru kwantu czasu","niektóre procesy mogą otrzymywać większą ilość losów"],"zależy od doboru kwantu czsu"),
    ...
    new Question("W terminologii SO semaforem nazywamy",["Ogólna implementacją algorytmy BFS","Sekcję krytyczną","Metodę dostępu do chronionego zasobu przez wiele procesów","Problem ucztujących filozofów"],"Metodę dostępu do chronionego zasobu przez wiele procesów"),
    ...
    new Question("Efekt polecenia mkdir count to",["Ucięcie korzenia w drzewie struktury drzewiastej","Polecenie zwróci ilość katalogów w bieżącej lokalizacji","Powstanie wpisu dotyczącego nowego katalogu count"],"Powstanie wpisy dotyczącego nowego katalogu count"),
    ...
    new Question("Pamięć wirtualna to",["pamięć wytwarzana przez procesy na ich cele","pamięć, z której mogą korzystać przeglądarki internetowe","oddzielenie logicznej pamięci użytkownika od pamięci fizycznej"],"odzielenie logicznej pamięci użytkownika od pamięci fizycznej"),
